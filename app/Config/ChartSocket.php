 ...
 */
class ChartSocket extends \Takielias\CodeigniterWebsocket\Config\CodeigniterWebsocket
{
    public $host = "0.0.0.0";
    public $port = 8282;
    public $timer = false;
    ...
    public $callbacks = ['auth', 'event', 'close', 'citimer', 'roomjoin', 'roomleave', 'roomchat', 'update_chart'];
}
